...
#load saved weights
best_model.load_weights(os.path.join('saved_weights.weights.h5'))
...
print(test_results)
print(test_results["Prediction"].mean())

#write out file with results
text_file = open("Output.txt", "w")
to_be_written = test_results.to_string()
to_be_mean = str(test_results["Prediction"].mean())

text_file.write(to_be_written + '\n' + 'mean deepfake value: ' +to_be_mean)
text_file.close()
